...
- El proyecto debe **dar soporte específico a Navarra** o incluir funcionalidades relevantes para usuarios en esta comunidad foral.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución navarra** a la que el software da soporte (p.ej. navarra.es, unavarra.es, unav.edu). Esto ayuda a verificar que el proyecto es relevante para Navarra.
